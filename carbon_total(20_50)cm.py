...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil carbon total(20_50)cm\masked_carbon_total_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
carbon_total_20_50 = ds['mean_20_50']  # You might need to adjust variable names based on your NetCDF file structure
#carbon_total_20_50_2d = carbon_total_20_50.isel(time=0)
lat = ds['lat']
lon = ds['lon']

#converting from g/kg to percentage 
carbon_total_percentage_20_50 = carbon_total_20_50 / 10
...
values = carbon_total_percentage_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_ct_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil Carbon Total Mean_20_50 Values (%)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Carbon Total (20-50)cm')
...
#plt.title('Distribution of Soil Carbon Total Mean_20_50 Values (%)')
#plt.xlabel('Soil Carbon Total Mean_20_50 Values (%)')
