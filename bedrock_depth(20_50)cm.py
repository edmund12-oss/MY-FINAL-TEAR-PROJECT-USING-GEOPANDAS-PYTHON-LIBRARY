...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil bedrock depth(20_50)cm\masked_depth_2.nc'
ds = xr.open_dataset(nc_file)



# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
bedrock_depth_2d_20_50 = ds['mean_0_200']  # You might need to adjust variable names based on your NetCDF file structure
...
#180, 200
values = bedrock_depth_2d_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_bd_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil Bedrock Depth Mean_20_50 Values (cm)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Bedrock Depth (20_50)cm')
...
#plt.title('Distribution of Soil Bedrock Depth Mean_20_50 Values (cm)')
#plt.xlabel('Soil Bedrock Depth Mean_20_50 Values (cm)')
