...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil ph(20_50)cm\masked_ph_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variable
ph_20_50 = ds['pH, predicted mean at 20-50 cm depth']  # You might need to adjust variable names based on your NetCDF file structure
lat = ds['lat']
lon = ds['lon']
...
values = ds['pH, predicted mean at 20-50 cm depth'].values
...
contour = ax.contourf(lon, lat, combined_classes_ph_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil pH Mean_20_50 Values', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil pH (20-50)cm')
...
#plt.title('Distribution of Soil pH Mean_20_50 Values')
#plt.xlabel('Soil pH Mean_20_50 Values')
