...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil clay content(20_50)cm\masked_clay_content_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
clay_content_2d_20_50 = ds['mean_20_50']  # You might need to adjust variable names based on your NetCDF file structure
#clay_content_20_50_2d =clay_content_20_50.isel(time=0)
lat = ds['lat']
lon = ds['lon']
...
values = clay_content_2d_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_clay_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil Clay Content Mean_20_50 Values (%)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Clay Content (20-50)cm')
...
#plt.title('Distribution of Soil Clay Content Mean_20_50 Values (%)')
#plt.xlabel('Soil Clay Content Mean_20_50 Values (%)')
