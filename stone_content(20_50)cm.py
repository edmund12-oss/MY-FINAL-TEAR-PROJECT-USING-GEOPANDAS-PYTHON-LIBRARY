...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil stone content(20_50)cm\masked_stone_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variable
stone_content_20_50 = ds['Stone content, predicted mean at 20-50 cm depth']  # You might need to adjust variable names based on your NetCDF file structure
lat = ds['lat']
lon = ds['lon']
...
values = ds['Stone content, predicted mean at 20-50 cm depth'].values
...
contour = ax.contourf(lon, lat, combined_classes_stone_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil Stone Content Mean_20_50 Values (%)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Stone Content (20-50)cm')
...
#plt.title('Distribution of Soil Stone Content  Mean_20_50 Values (%)')
#plt.xlabel('Soil Stone Content Mean_20_50 Values (%)')
