...
nc_file = r'E:\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil magnesium extractable(20_50)cm\masked_magnesium_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variable
magnesium_extractable_20_50 = ds['Magnesium, extractable, predicted mean at 20-50 cm depth']  # You might need to adjust variable names based on your NetCDF file structure
lat = ds['lat']
lon = ds['lon']
...
highly_suitable_mg_20_50 = np.where((magnesium_extractable_final_20_50 >= highly_suitable_threshold_mg_1) & (magnesium_extractable_final_20_50 <= highly_suitable_threshold_mg_2), 1, 0)
moderately_suitable_mg_20_50 = np.where((magnesium_extractable_final_20_50 >= moderately_suitable_threshold_mg_1) & (magnesium_extractable_final_20_50 < highly_suitable_threshold_mg_1) & (magnesium_extractable_final_20_50 > highly_suitable_threshold_mg_2) & (magnesium_extractable_final_20_50 <= moderately_suitable_threshold_mg_2), 0.67, 0)  #& (magnesium_extractable_final > highly_suitable_threshold_mg_2) & (magnesium_extractable_final <= moderately_suitable_threshold_mg_2), 0.67, 0)
marginally_suitable_mg_20_50 = np.where((magnesium_extractable_final_20_50 < moderately_suitable_threshold_mg_1) & (magnesium_extractable_final_20_50 >= marginally_suitable_threshold_mg_1) &(magnesium_extractable_final_20_50 > moderately_suitable_threshold_mg_2) & (magnesium_extractable_final_20_50 <= marginally_suitable_threshold_mg_2), 0.33, 0)
unsuitable_mg_20_50 = np.where((magnesium_extractable_final_20_50 < marginally_suitable_threshold_mg_1) & (magnesium_extractable_final_20_50 > marginally_suitable_threshold_mg_2) ,0, 0)
...
values = magnesium_extractable_final_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_mg_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Magnesium Extractable Mean_20_50 Values (g/kg)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Magnesium Extractable (20-50)cm')
...
#plt.title('Distribution of Magnesium Extractable Mean_20_50 Values (g/kg)')
#plt.xlabel('Magnesium Extractable Mean_20_50 Values (g/kg)')
