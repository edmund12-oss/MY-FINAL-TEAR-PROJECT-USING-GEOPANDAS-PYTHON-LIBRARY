...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil aluminium map(20_50)cm\masked_aluminium_3.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
aluminium_extractable_20_50 = ds['Aluminium, extractable, predicted mean at 20-50 cm depth']  # You might need to adjust variable names based on your NetCDF file structure
lat = ds['lat']
lon = ds['lon']
...
values = aluminium_extractable_final_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_al_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Aluminium Extractable Mean_20_50 Values (g/kg)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Aluminium (20-50)cm')
...
#plt.title('Distribution of Aluminium Extractable Mean_20_50 Values (g/kg)')
#plt.xlabel('Aluminium Extractable Mean_20_50 Values (g/kg)')
