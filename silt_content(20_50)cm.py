...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil silt content(20_50)cm\masked_silt_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
silt_content_2d_20_50 = ds['mean_20_50']  # You might need to adjust variable names based on your NetCDF file structure
#silt_content_20_50_2d = silt_content_20_50.isel(time=0)
lat = ds['lat']
lon = ds['lon']
...
values = silt_content_2d_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_silt_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Silt Content Mean_20_50 Values (%)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Silt Content (20-50)cm')
...
#plt.title('Distribution of Soil Silt Content Mean_20_50 Values (%)')
#plt.xlabel('Soil Silt Content Mean_20_50 Values (%)')
