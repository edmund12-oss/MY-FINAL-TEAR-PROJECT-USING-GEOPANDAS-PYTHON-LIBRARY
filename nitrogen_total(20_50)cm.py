...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil nitrogen total(20_50)cm\masked_nitrogen_total_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variable
nitrogen_total_20_50 = ds['Nitrogen, total, predicted mean at 20-50 cm depth']  # You might need to adjust variable names based on your NetCDF file structure
lat = ds['lat']
lon = ds['lon']
...
#65.68631744, 24342.01953125
values = nitrogen_total_final_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_nitrogen_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Nitrogen Total Mean_20_50 Values (g/kg)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Nitrogen Total (20-50)cm')
...
#plt.title('Distribution of Nitrogen Total Mean_20_50 Values (g/kg)')
#plt.xlabel('Nitrogen Total Mean_20_50 Values (g/kg)')
