...
nc_file = r'C:\Users\hp\Desktop\project execution\geopandas\New thematic maps\soil_maps(20_50)cm\soil bulk density(20_50)cm\masked_bulk_density_2.nc'
ds = xr.open_dataset(nc_file)

# Assuming the dataset contains 'bulk_density', 'lat', and 'lon' variables
bulk_density_2d_20_50 = ds['mean_20_50']  # You might need to adjust variable names based on your NetCDF file structure
#bulk_density_20_50_2d =bulk_density_20_50.isel(time=0)
lat = ds['lat']
lon = ds['lon']
...
values = bulk_density_2d_20_50.values
...
contour = ax.contourf(lon, lat, combined_classes_bdensity_20_50, cmap=cmap, levels=boundaries, norm=norm)
...
# Add colorbar
#cbar = plt.colorbar(contour, ax=ax, label='Soil Bulk Density Mean_20_50 Values (g/cm3)', norm=norm, boundaries=boundaries, ticks=boundaries)
ax.set_title('Soil Bulk Density (20-50)cm')
...
#plt.title('Distribution of Soil Bulk Density Mean_20_50 Values (g/cm3)')
#plt.xlabel('Soil Bulk Density Mean_20_50 Values (g/cm3)')
